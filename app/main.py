...
async def start_cmd(message: Message) -> None:
    ...
    welcome_text = (
        "✨ <b>Добро пожаловать в TTH NFT</b> – мир уникальных коллекционных номеров и бесконечных возможностей! ✨<br><br>"
        "Чтобы начать своё приключение, выполните команду:<br>   <code>/login &lt;Ваш Telegram ID&gt;</code><br><br>"
        "После входа в систему вы сможете использовать команды: /mint, /collection, /balance, /sell, /market, /buy, /participants, /exchange, /logout<br><br>"
        "Для смены аватарки отправьте фото с подписью: /setavatar<br><br>"
    )
...
async def process_help_callback(callback_query: CallbackQuery) -> None:
    commands_text = (
        "💡 <b>Список команд TTH NFT</b> 💡<br><br>"
        "🔸 <b>/start</b> – Приветствие и инструкции<br>"
        "🔸 <b>/login &lt;Ваш Telegram ID&gt;</b> – Вход в аккаунт для получения кода подтверждения<br>"
        "🔸 <b>/verify &lt;код&gt;</b> – Подтверждение входа<br>"
        "🔸 <b>/logout</b> – Выход из аккаунта<br>"
        "🔸 <b>/setavatar</b> – Обновление аватарки (отправьте фото с подписью)<br>"
        "🔸 <b>/setdesc &lt;описание&gt;</b> – Изменение описания профиля<br>"
        "🔸 <b>/mint</b> – Создание нового уникального токена<br>"
        "🔸 <b>/transfer &lt;ID получателя&gt; &lt;номер токена&gt;</b> – Передача токена другому пользователю<br>"
        "🔸 <b>/collection</b> – Просмотр вашей коллекции токенов<br>"
        "🔸 <b>/balance</b> – Просмотр баланса аккаунта<br>"
        "🔸 <b>/sell &lt;номер токена&gt; &lt;цена&gt;</b> – Выставление токена на продажу<br>"
        "🔸 <b>/market</b> – Просмотр маркетплейса<br>"
        "🔸 <b>/buy &lt;номер листинга&gt;</b> – Покупка токена<br>"
        "🔸 <b>/updateprice &lt;номер листинга&gt; &lt;новая цена&gt;</b> – Обновление цены для вашего листинга<br>"
        "🔸 <b>/withdraw &lt;номер листинга&gt;</b> – Снятие токена с продажи и возвращение его в коллекцию<br>"
        "🔸 <b>/participants</b> – Список участников сообщества<br>"
        "🔸 <b>/referral</b> – Получить реферальную ссылку<br>"
        "🔸 <b>/referrals</b> – Посмотреть статистику по вашим рефералам<br><br>"
        "🔸 <b>/auction &lt;номер токена&gt; &lt;начальная цена&gt; &lt;длительность (мин)&gt;</b> – Создание аукциона для вашего токена<br>"
        "🔸 <b>/bid &lt;auction id&gt; &lt;ставка&gt;</b> – Сделать ставку в активном аукционе<br><br>"
